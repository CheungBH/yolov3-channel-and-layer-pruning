...
cmds = [
    'python train_sparse.py --cfg pretrained/prev/yolov3-spp-1cls.cfg --batch-size 8 --s 1.5E-3 --epochs 300 -sr '
    '--LR 1.5E-3 --optimize sgd --weights pretrained/prev/135_608_best.weights --save_interval 10 --multi-scale True '
    '--img_size 416 --rect True --data data/gray/gray.data  --wdir s1.5E-3_lr1.5E-3'
]
