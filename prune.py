...
if __name__ == '__main__':
    ...
    os.makedirs("weights/prune_0.85_gray_sE-3")
    if compact_model_name.endswith('.pt'):
        compact_model_name = compact_model_name.replace('.pt', '.weights')
    save_weights(compact_model, compact_model_name)
    print(f'Compact model has been saved: {compact_model_name}')

# python prune.py --cfg cfg/yolov3-1cls.cfg --data data/swim_gray/gray.data --weights weights/gray_sE-3/best.pt --percent 0.85