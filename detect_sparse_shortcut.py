...
if __name__ == '__main__':
    ...
    sparse_file = open(os.path.join("/".join(opt.weights.split("/")[:-1]), "sparse_shortcut_result.txt"), "w")

    percent_ls = [num/100 for num in range(opt.percent_min, opt.percent_max, 1)]
    ...
    for percent in percent_ls:
        ...
        print("{}---->{}".format(percent, threshold), file=sparse_file)
